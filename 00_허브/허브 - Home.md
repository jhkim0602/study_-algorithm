...
`doit_dsalgo_with_python-master`의 실습 코드는 파일이 많아 보이지만, 실제 학습 흐름은 몇 가지 반복 패턴으로 정리된다.
...
`doit_dsalgo_with_python-master`는 앞으로 개념노트의 보조 실습 폴더로 사용한다.
...
- 말로 설명 훈련: [[02 - 질문 은행]]
- 전체 점검: [[03 - 체크리스트]]
- 1분 설명 연습: [[04 - 1분 설명 카드]]
- 개념 비교 정리: [[05 - 비교표]]
- 스스로 풀어보기: [[06 - 미니 문제 세트]]
